        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget  widget-box box-container form-main widget-form-cart" id="form">
                    <form method="post" action="./index.php?seccion=em_anticipo&accion=lee_archivo&session_id=<?php echo $controlador->session_id; ?>" class="form-additional" enctype="multipart/form-data">
